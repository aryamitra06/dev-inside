...
import { SimpleGrid, FormControl, FormLabel, Input, Select, FormHelperText, Textarea, Text, Tag, InputGroup, InputLeftElement, Button, Box } from '@chakra-ui/react'
        ...
        <Fragment>
            ...
            <SimpleGrid columns={{ base: 1, sm: 1, md: 1, lg: 1, xl: 1 }} spacing={5} mb={3}>
                <FormControl>
                    ...
                    <Textarea type='text' name='bio' value={bio} onChange={(e) => onChange(e)} isDisabled={response.loading}/>
            ...
            <SimpleGrid columns={{ base: 1, sm: 1, md: 2, lg: 2, xl: 2 }} spacing={5}>
                ...
                <FormControl isRequired>
                    ...
                    <Select placeholder='Select option' name='status' value={status} onChange={(e) => onChange(e)} isDisabled={response.loading}>
                ...
                <FormControl isRequired>
                    ...
                    <Input type='text' name='skills' value={skills} onChange={(e) => onChange(e)} isDisabled={response.loading}/>
                    <FormHelperText>Please use comma separated values (eg. HTML,CSS,React,Node)</FormHelperText>
                </FormControl>
                <FormControl>
                    <FormLabel>GitHub Username</FormLabel>
                    <Input type='text' name='githubusername' value={githubusername} onChange={(e) => onChange(e)} isDisabled={response.loading}/>
            ...
            <Box display={"flex"} justifyContent={"flex-end"}>
                <Button colorScheme='blue' type='submit' isDisabled={response.loading}>Create</Button>
            </Box>
            </form>
        </Fragment>
    )
